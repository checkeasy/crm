      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="fixed top-3 left-3 z-50 h-10 w-10 rounded-xl bg-background/80 backdrop-blur-sm border border-border/50 shadow-sm hover:shadow-md transition-all duration-200"
          >
        ...
        <SheetContent
          side="left"
          className="w-72 p-0 border-r-0 bg-[oklch(0.18_0.04_260)] overflow-hidden"
        >
          <SheetTitle className="sr-only">Navigation</SheetTitle>

          {/* Gradient overlay matching sidebar */}
            ...
            <div className="p-3 border-t border-white/[0.08]">
              <div className="flex items-center gap-3 px-2 py-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-white/40 truncate">Commercial SaaS</p>
                </div>
              </div>
            </div>
          </div>
